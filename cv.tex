...
\begin{tabularx}{\textwidth}{X r}
  ...
  {}\\
  \href{https://www.linkedin.com/in/iduwara/}{LinkedIn} $|$ \href{https://github.com/harithiduwara}{GitHub} $|$ \href{https://t.me/harithiduwara}{Telegram} \\
  Email: \href{mailto:contactharith@gmail.com}{contactharith@gmail.com} $|$ WhatsApp / Telegram: @harithiduwara
\end{tabularx}
\end{minipage}
\hfill
\begin{minipage}[t]{0.15\textwidth}
  \begin{tabular}{r}
    ...
    \includegraphics[width=1.9cm]{photo.png}
  \end{tabular}
\end{minipage}
